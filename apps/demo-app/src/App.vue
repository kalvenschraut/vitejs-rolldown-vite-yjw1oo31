<template>
	<div id="app">
		<header class="app-header">
			...
			<p class="subtitle">
				Showcasing Vue components built with rolldown-vite
			</p>
		</header>
				...
				<div class="composables-grid">
					...
					<div class="composable-demo">
						...
						<div class="counter-controls">
							<button
								@click="counterActions.decrement"
								:disabled="!counterActions.canDecrement.value">
								-{{ counterOptions.step }}
							</button>
							...
							<button
								@click="counterActions.increment"
								:disabled="!counterActions.canIncrement.value">
								+{{ counterOptions.step }}
							</button>
						</div>
						<div class="counter-info">
							<p>
								Min: {{ counterOptions.min }} | Max:
								{{ counterOptions.max }}
							</p>
							<button
								@click="counterActions.reset"
								class="reset-btn">
								Reset
							</button>
						</div>
						...
						<div class="validator-inputs">
							...
							<div class="input-group">
								...
								<div
									...
									<div
										v-if="passwordValidation.errors.length"
										class="errors">
										{{
